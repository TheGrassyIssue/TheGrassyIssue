#!/usr/bin/env python3
"""wire-towels-home.py — the Fall Golf Towel Roundup feed card, slot 1.
25 September 2026.
...
brands' own photography, localised to images/fall-towels-2026/. Only the Takomo slide
...
POST = ROOT / "drops/fall-golf-towel-roundup-2026.html"
SLUG = "/drops/fall-golf-towel-roundup-2026"
KEY = "towels1"
MARK, END = "<!-- TGI-TOWELS-CARD -->\n", "<!-- /TGI-TOWELS-CARD -->\n"
TITLE = "The Ultimate Fall Golf Towel Roundup &mdash; 50 Towels, 50 Brands"
CARD_OPEN = '<div class="card" data-type='

# Lenny approved the post and said "let's push" (25 Sep 2026). Slide 1 is the post hero.
# (image, alt, brand line, headline, slide text)
SLIDES = [
    ("card-sunday", "A golfer with a stack of Sunday Golf towels over his shoulders and a drink in his hand",
     "Fall towel roundup · 50 brands", "50 towels, 50 independent brands",
     "Fifty towels from fifty independent brands, one each: knits, chenille, Japanese gauze, jacquard, magnets "
     "and a newspaper towel from USAG. $12.95 to $57. Every price was read on 25 September."),
    ("devereux-golf-1", "A man in the desert holding up the Devereux Knitted Cactus Voodoo towel",
     "Devereux · Knitted Cactus Voodoo · $38", "Our pick for fall",
     "Devereux knits its Cactus Voodoo graphic into heavy black cotton. It is the towel we would reach for first this season."),
    ("hazy-golf-1", "A golfer on the course holding a white Hazy Golf caddy towel",
     "Hazy Golf · Tour Towel · $20", "The classic caddy towel",
     "A white ribbed caddy towel with an embroidered Hazy script. It is one of fifteen in the loud section."),
    ("irl-a1", "A Shoal Golf Co. cap and a cream towel on an olive stand bag on the grass",
     "Shoal · on the bag", "Jacquard, plaid and pattern",
     "Shoal's caddie towel has a scrub pad built into one end. It leads a section of woven patterns, paisley and camo."),
    ("mnml-golf-1", "An MNML Golf towel hanging from a stand bag on the course",
     "MNML Golf · Eco Golf Towel · $49", "Magnetic and technical",
     "MNML makes its waffle towel entirely from recycled plastic. The last section is magnets and technical builds."),
]
...
def build_card():
    ...
    for img, alt, brand, headline, _ in SLIDES:
        slides.append(
            ...
            f'            <a href="{SLUG}">\n'
            f'              <img src="/images/fall-towels-2026/{img}.jpg" alt="{html.escape(alt)}" loading="lazy" />\n'
...
def verify(original):
    ...
    for img, *_ in SLIDES:
        if not (ROOT / f"images/fall-towels-2026/{img}.jpg").is_file():
    ...
    print("  wrote index.html — towel roundup card in slot 1")
